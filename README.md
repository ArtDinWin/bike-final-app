...
### Что реализовано?
1. Верстка макета (свой, свободный стиль)
2. Взаимодействие фронтенда SPA на React.js v18 и Redux c готовым API
3. Для авторизованных запросов используется Bearer Token 
4. Запросы к бекенд-серверу через запросы axios
5. Страницы доступные всем пользователям без авторизации:
